...
class Customer(models.Model):
    ...
    def get_status(self):
        ...
        return mark_safe("<span style='background-color:%s;color:white'>%s<span>"%(status_dic[self.status],self.get_status_display()))
...
# lyq=UserInfo.objects.filter(pk=1)
# print(lyq.get_gender_display())